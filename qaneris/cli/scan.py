...
from qaneris.cli.source import print_connection_report, print_scan_report
...
from qaneris.scanning import MultiDatabaseScanRunner, ScanRunConfigurationError


def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="qaneris-scan",
        description="Compatibility entry point; prefer 'qaneris source'.",
    )
