...
from qaneris.answering.composer import _private_field, _safe_text, _safe_value
...
from qaneris.diagnostics.composer import DiagnosticComposer, deterministic_answer
from qaneris.diagnostics.models import (
    DiagnosticBudget,
    DiagnosticFinding,
...
from qaneris.diagnostics.policy import question_key, select_questions
...
class DiagnosticCoordinator:
    ...
    def _wait_for_clarification(self, run, question: str, message: str) -> None:
        from qaneris.contracts import AskClarification
