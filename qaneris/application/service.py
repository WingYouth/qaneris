...
from qaneris.common.numbers import normalize_number, normalize_rows
from qaneris.common.redaction import SecretRedactor, safe_error, sensitive_values
...
from qaneris.connections.references import managed_secret_ids
...
from qaneris.llm.gateway import AiyallmSchemaModel, summarize_without_model
from qaneris.llm.ports import SchemaModel
from qaneris.querying import (
...
from qaneris.security import is_sensitive_field
...
class QanerisService:
    ...
    @classmethod
    def from_environment(cls) -> QanerisService:
        ...
        """
        return cls(Catalog(os.getenv("QANERIS_CATALOG", "qaneris.db")))
    ...
    def import_excel(self, request: ExcelImportRequest) -> ExcelImportResult:
        """Import a ``.xlsx`` workbook as a first-class Qaneris datasource.
    ...
    def _ask_error_detail(error: Exception) -> ErrorDetail:
        ...
        if isinstance(error, QanerisError):
