...
from smartdata.contracts.semantic import BusinessFilter, BusinessObjective, BusinessQuery
...
from smartdata.semantic import IntentUnderstandingPipeline, LLMBusinessParser
...
def main() -> int:
    ...
    service: SmartDataService = app.state.service
