...
Run against a Catalog whose datasources have already been scanned and published:
    ...
    python -m smartdata.scripts.acceptance.semantic_graph_retrieval --catalog <path> \
...
from smartdata.graph import Neo4jConfig, Neo4jGraphReader
from smartdata.graph.reading import GraphStructure, GraphStructureRequest
