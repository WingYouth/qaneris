...
from smartdata.contracts import AskRequest, AskStatus
from smartdata.contracts.query import TimeSpec
...
from smartdata.scripts.acceptance.phase1_e2e_scope import (
    WORKSPACE_ID,
    build_source,
    ensure_datasource,
)
...
class Phase1AcceptanceRunner:
    ...
    def __init__(
        self,
        *,
        service_factory: Callable[[Catalog], SmartDataService] = SmartDataService,
