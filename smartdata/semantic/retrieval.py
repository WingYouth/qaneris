...
from smartdata.semantic.models import SemanticRetrievalPath, SemanticRetrievalResult
from smartdata.semantic.normalization import normalize_term as _normalize
