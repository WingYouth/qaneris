...
from smartdata.contracts.query import GroundedQueryPlan, NativeQuery, QueryLanguage
from smartdata.querying.validation.read_only import _strip_for_safety, validate_read_only_query
...
class GroundedNativeQueryValidator:
    ...
    def _validate_mongo(query: NativeQuery, plan: GroundedQueryPlan) -> None:
        from smartdata.querying.generation.grounded_mongo import GroundedMongoCompiler
    ...
    def _validate_redis(query: NativeQuery, plan: GroundedQueryPlan) -> None:
        from smartdata.querying.generation.grounded_redis import GroundedRedisCompiler
