...
:mod:`smartdata.ingestion.excel.validator`, SQLite writing in
:mod:`smartdata.ingestion.excel.materializer`, and this module never writes Catalog datasets, fields
...
from smartdata.ingestion.excel.materializer import SQLiteMaterializer, TableWrite
