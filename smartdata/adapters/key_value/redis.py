...
from smartdata.adapters.native_query import parse_query_payload
from smartdata.adapters.native_values import normalize_sample_value
...
class RedisAdapter(DataSourceAdapter):
    ...
    def _client(self):
        try:
            ...
            raise RuntimeError("Redis support requires smartdata-platform[redis]") from error
