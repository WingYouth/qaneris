...
call one ``SmartDataService`` method, and project the result through the same ``ManagedCredentialPublic``
...
from smartdata.cli.render import operation_error_detail
