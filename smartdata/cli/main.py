...
from smartdata.cli.ask import ASK_COMMAND, add_ask_command, run_ask_command
from smartdata.cli.config import DatasourceConfigError
from smartdata.cli.credentials import (
    CERTIFICATE_COMMAND,
    CREDENTIAL_COMMAND,
...
from smartdata.cli.doctor import doctor_passed, inspect_environment
from smartdata.cli.source import (
    CATALOG_COMMANDS,
...
from smartdata.contracts import ConnectionTestReport
from smartdata.ingestion.excel import ExcelIngestionError
from smartdata.scanning import ScanRunConfigurationError
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="smartdata",
        description="SmartData command-line interface.",
    )
    parser.add_argument(
        "--env-file",
        type=Path,
        help="load this dotenv file (then SMARTDATA_ENV_FILE, then cwd/.env)",
    )
